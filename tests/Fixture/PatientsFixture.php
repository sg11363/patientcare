...
class PatientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'street_address' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'zipcode' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'phone' => 1,
                'created' => '2019-04-25 15:04:33',
                'modified' => '2019-04-25 15:04:33'
            ],
        ];
        parent::init();
    }
